...
export function SmartDownloader() {
  ...
  return (
    <div className="flex flex-col items-start w-full font-['TruistTrio']">
      <button
        onClick={handleLiveChatClick}
        className="w-full flex justify-center items-center h-[56px] bg-truist-purple text-white font-bold text-[18px] tracking-wide rounded hover:bg-truist-purple-hover transition-colors cursor-pointer border-none"
      >
      ...
      <div className="mt-8 w-full p-5 bg-truist-gray-bg border border-[#E6E6E6]">
        <h3 className="text-[16px] text-[#333] mb-3 font-bold font-['TruistTrio']">Other ways to contact {loading ? "us" : regionData.brandName}</h3>
