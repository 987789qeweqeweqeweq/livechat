  ...
  return (
    <div className="flex flex-col items-start w-full">
      <button
        ...
        className="w-full flex justify-center items-center h-[52px] bg-citi-blue text-white font-semibold text-[16px] tracking-wide rounded hover:bg-citi-blue-hover transition-colors cursor-pointer border-none"
      >
      ...
      <div className="mt-8 w-full p-5 bg-citi-gray-bg rounded-lg border border-citi-gray-border">
        <h3 className="text-[15px] text-citi-navy mb-3 font-semibold">
          Other ways to contact {loading ? "us" : regionData.brandName}
        </h3>
        <div className="flex flex-col gap-2 mt-4">
          <p className="text-[13px] text-citi-text-secondary mb-1">Telephone Banking Support:</p>
          <p className="font-semibold text-[18px] text-citi-navy">
            {loading ? "Loading..." : regionData.supportPhone}
          </p>
          <p className="text-[12px] text-citi-input-border mt-1">Lines are open 24/7. Standard rates apply.</p>
        </div>
      </div>
    </div>
  );
